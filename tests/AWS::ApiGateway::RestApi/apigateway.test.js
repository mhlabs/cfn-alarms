...
test("Generate alarms test", async () => {
  for (const alarm of Object.keys(alarmConfig).map(
    ...
    await generator.generate(alarm, testTemplate, "AWS::ApiGateway::RestApi", alarmResources, "test-api");
